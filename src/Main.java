...
public class Main {
    public static void main(String[] args) {
        ...
        Employe employe1 = new Employe(1, "Torkhani", "Ghofrane", "IT", 2);
        Employe employe2 = new Employe(2, "Jiji", "ghogho", "HR", 3);
        Employe employe3 = new Employe(3, "toto", "Difi", "Finance", 1);
